        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          >
            <img
              ...
              className="mx-auto w-56 max-w-xs md:max-w-sm mb-2"
            />
          </motion.div>
            ...
            <AnimatePresence>
              {loading && (
                <motion.div
                  ...
                  className="flex justify-center"
                >
                  <div className="w-6 h-6 border-4 border-green-500 border-t-transparent rounded-full animate-spin mt-4"></div>
                </motion.div>
              )}
            </AnimatePresence>
